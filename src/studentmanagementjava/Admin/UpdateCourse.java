...
public class UpdateCourse extends javax.swing.JFrame {
    ...
    private void updateFields(String moduleId,String semester){
        
        
        
        try{
            semCombo.setSelectedItem(semester);
            ResultSet rs = CourseTableModel.getCoursesByModuleId(moduleId);
            while(rs.next()){
                modid.setText(rs.getString("moduleid"));
                modname.setText(rs.getString("name"));
                moddescription.setText(rs.getString("description"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            CourseTableModel.updateCourse(modid.getText(),modname.getText(),
                    semCombo.getSelectedItem().toString(),Double.parseDouble(modfee.getText()),moddescription.getText(),selectedModuleId);
            JOptionPane.showMessageDialog(this, "Course Module "+modname.getText()+" updated succesfully!");
            selectedModuleId = modid.getText();
        } catch (Exception e) {
